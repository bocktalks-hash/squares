...
function MainApp({ showTourOnMount }) {
  ...
  // Delay tour slightly so the UI is fully painted before spotlight measures
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* ── Tutorial tour ── */}
      {showTour && (
        <TutorialTour onDone={() => setShowTour(false)} />
      )}
    </>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center" }}>
        <img src="/logo.svg" alt="Bock Talks" style={{
...
const appStyles = `
  ...
  .guest-banner-btn {
    background: none; border: 1px solid #3366cc;
    color: #3366cc; border-radius: 6px;
